...
public class AStar {
    ...
    public static List<Node> findPath(World world, Vector2i start, Vector2i end) {
        ...
        //Nó da entidade atual que procura o caminho
        ...
        while(openlist.size() > 0) {
            ...
            if(current.tile.equals(end)) {
                ...
                //Equanto não for o primeiro nó ele ira adicionar no caminho
            ...
            for(int i = 0; i < 9; i++) {
                ...
                int xi = (i%3) - 1;
                int yi = (i/3) - 1;
                //Verifica caminhos bloqueados ou Tiles null
                ...
                //irá calcular o custo h e g
                // g é o custo total do caminho
                // h é o custo entre os dois pontos atuais
